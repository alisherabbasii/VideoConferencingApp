    ...
    ui: {
        ...
        */
        brand: {
            ...
            meta: {
                description:
                    'Mualim Ul Quran powered by WebRTC and mediasoup, Real-time Simple Secure Fast video calls, messaging and screen sharing capabilities in the browser.',
                keywords:
